...
export function HomePage() {
  const products = [
    ...
    {
      title: "Método IDEIA",
      description: "Sistema completo de gestão com inteligência artificial",
      icon: Brain,
      link: "/metodo-ideia",
    ...
    {
      title: "E-books",
      description: "3 e-books publicados sobre IA na advocacia",
      icon: BookOpen,
      link: "#ebooks",
      highlight: false
    },
    {
      title: "Curso IDEIA",
      description: "Formação completa em Inteligência de Dados e Artificial",
      icon: GraduationCap,
      link: "#curso",
      highlight: false
    },
    {
      ...
      description: "Acompanhamento personalizado para advogados",
      icon: Users,
      link: "#mentoria",
      highlight: false
    },
    {
      title: "Imersão IDEIA",
      description: "Experiência intensiva de aprendizado prático",
      icon: Lightbulb,
      link: "#imersao",
      highlight: false
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <nav className="relative z-10 container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold text-white">Raphael Hague</span>
            </div>
            <div className="hidden md:flex items-center gap-6">
              <a href="#sobre" className="text-slate-300 hover:text-white transition-colors">Sobre</a>
              <a href="#produtos" className="text-slate-300 hover:text-white transition-colors">Produtos</a>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight">
                  Transformando a <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">Advocacia</span> com Inteligência Artificial
                </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Button size="lg" className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white shadow-lg shadow-blue-500/25" asChild>
                  <a href="/consultoria">
                    Iniciar Consultoria
              ...
              <div className="flex items-center gap-4 pt-4">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-slate-800 text-slate-300 hover:text-pink-400 hover:bg-slate-700 transition-all">
                  <Instagram className="h-5 w-5" />
                </a>
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-slate-800 text-slate-300 hover:text-blue-400 hover:bg-slate-700 transition-all">
                  <Linkedin className="h-5 w-5" />
                </a>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-slate-800 text-slate-300 hover:text-red-400 hover:bg-slate-700 transition-all">
                  <Youtube className="h-5 w-5" />
                </a>
                <a href="mailto:contato@raphaelhague.com" className="p-2 rounded-full bg-slate-800 text-slate-300 hover:text-cyan-400 hover:bg-slate-700 transition-all">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30 mb-4">Sobre</Badge>
              <h2 className="text-3xl md:text-4xl font-bold text-white">Quem é Raphael Hague</h2>
            </div>
            ...
            <div className="mt-12 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-2xl p-8 border border-blue-500/20">
              <p className="text-lg text-slate-300 leading-relaxed">
                Sou advogado e mentor especializado em ajudar escritórios de advocacia a implementarem 
                soluções de Inteligência Artificial em suas rotinas. Através do <strong className="text-white">Método IDEIA</strong> 
      ...
      <section id="produtos" className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30 mb-4">Produtos & Serviços</Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-white">Soluções para sua Advocacia</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map((product, index) => (
              <Card 
                key={index} 
                className={`bg-slate-900/50 border-slate-700 hover:border-blue-500/50 transition-all duration-300 group ${
                  product.highlight ? 'ring-2 ring-blue-500/30' : ''
                }`}
              >
                <CardContent className="p-6">
                  {product.logo ? (
                    ...
                    <product.icon className="h-12 w-12 text-blue-400 mb-4 group-hover:text-cyan-400 transition-colors" />
                  )}
                  <h3 className="text-xl font-semibold text-white mb-2">{product.title}</h3>
                  <p className="text-slate-400 mb-4">{product.description}</p>
                  <Button 
                    variant="ghost" 
                    className="text-blue-400 hover:text-cyan-400 hover:bg-blue-500/10 p-0"
                    asChild
                  >
                    <a href={product.link}>
                      Saiba mais
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600/20 to-cyan-600/20">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button size="lg" className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white" asChild>
              <a href="/consultoria">
                Agendar Consultoria
                <ExternalLink className="ml-2 h-4 w-4" />
              </a>
            ...
            <Button size="lg" variant="outline" className="border-white/30 text-white hover:bg-white/10" asChild>
              <a href="mailto:contato@raphaelhague.com">
      ...
      <footer id="contato" className="py-12 bg-slate-900 border-t border-slate-800">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-white">Raphael Hague</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/consultoria" className="text-slate-400 hover:text-blue-400 transition-colors">Consultoria</a></li>
                <li><a href="/metodo-ideia" className="text-slate-400 hover:text-blue-400 transition-colors">Método IDEIA</a></li>
                <li><a href="#ebooks" className="text-slate-400 hover:text-blue-400 transition-colors">E-books</a></li>
                <li><a href="/privacidade" className="text-slate-400 hover:text-blue-400 transition-colors">Política de Privacidade</a></li>
              </ul>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-slate-800 text-center text-slate-400">
            <p>&copy; {new Date().getFullYear()} Raphael Hague. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
