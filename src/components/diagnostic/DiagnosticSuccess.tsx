...
export function DiagnosticSuccess({ clientName }: DiagnosticSuccessProps) {
  return (
        ...
        <CardContent className="pt-8 pb-8 text-center space-y-6">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <div className="bg-muted/50 rounded-lg p-4 text-left space-y-3">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex items-start gap-2">
                  <ArrowRight className="w-4 h-4 mt-0.5 text-primary flex-shrink-0" />
                  <span>Agendamento da primeira reunião de consultoria</span>
                </li>
                <li className="flex items-start gap-2">
                  <ArrowRight className="w-4 h-4 mt-0.5 text-primary flex-shrink-0" />
                  <span>Início da implementação a quatro mãos</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-4">
            <p className="text-sm text-muted-foreground mb-4">
              Entraremos em contato em breve pelo e-mail ou WhatsApp informados.
            </p>
